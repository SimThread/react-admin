...
class ArticleEdit extends React.Component {
    ...
    async componentDidMount() {
        ...
        await setAlitaState({ funcName: 'getArticle', stateName: 'article', params: { id } });
    ...
    handleSave = async () => {
        ...
        const res = await updateArticle(article.data);
    ...
    render() {
        ...
        let handleSaveAndRepub = this.handleSaveAndRepub;
        ...
        return (
            <div>
                ...
                <div style={{ marginTop: '20px' }}>
                    ...
                    <RadioGroup onChange={this.handleChangeStatus} value={article.data.status}>
                ...
                <div style={{marginTop: '20px'}}>
                    ...
                    <Button type="primary" onClick={ handleSaveAndRepub }>保存并重新发布</Button>
                </div>
            </div>
        )
    }
